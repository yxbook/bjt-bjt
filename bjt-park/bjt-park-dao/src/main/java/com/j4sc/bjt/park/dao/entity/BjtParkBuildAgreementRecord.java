 ...
 * @since 2018-05-14
 */
@TableName("bjt_park_build_agreement_record")
public class BjtParkBuildAgreementRecord extends Model<BjtParkBuildAgreementRecord> {
    ...
    public String toString() {
        return "BjtParkBuildAgreementRecord{" +

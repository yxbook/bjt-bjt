package com.j4sc.bjt.system.dao;
...
public class Generator {
    // 根据命名规范，只修改此常量值即可
    private static String MODULE = "bjt-system";
    private static String DATABASE = "j4sc";
    private static String TABLE_PREFIX = "bjt_system";
    private static String PACKAGE_NAME = "com.j4sc.bjt.system";

...
/**
* @Description: BjtUserRole Service实现
* @Author: LongRou
...
@ApiIgnore
public class BjtUserRoleServiceImpl extends BaseServiceImpl<BjtUserRoleMapper, BjtUserRole> implements BjtUserRoleService {

    private static final Logger LOGGER = LoggerFactory.getLogger(BjtUserRoleServiceImpl.class);
